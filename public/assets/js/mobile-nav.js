var DIRECTION = { UP: 1, DOWN: 2, LEFT: 3, RIGHT: 4 },
  DropdownNavigation = function (t, e) {
    ...
    i
      ? ((this.isShort = i.classList.contains("-short")),
        (this.header = i),
        (this.headerRow = document.querySelector(".siteHeader__row")),
        (this.navigationLinks = i.querySelectorAll(
          ".navigation__link[data-nav-dropdown]"
        )),
        (this.navigationLinkWrapper = i.querySelector(".horizontalNavigation")),
        (this.mobileNavToggle = i.querySelector("#mobileNavToggle")),
        (this.dropdownWrapper = i.querySelector(
          ".navigation__dropdown__wrapper"
        )),
        (this.navigationDrawerDropdowns = i.querySelectorAll(
          ".navigation__dropdown"
        )),
        (this.featuredBackground = i.querySelector(
          ".navigation__dropdown__featured-background"
        )),
        (this.indicator = i.querySelector(".navigation__link-indicator")),
        (this.scrim = document.querySelector(".navigation__scrim")),
        (this.footer = i.querySelector(".navigation__dropdown__footer")),
        (this.topbar = document.querySelector(".topbar.-is-active")),
        (this.dropdowns = {}),
        (this.activeDropdownId = null),
        (this.previousActiveDropdownId = null),
        (this.closeTimer = null),
        (this.closeTimerDelay = e.closeTimerDelay || 100),
        (this.drawerCloseTimer = null),
        (this.drawerTimerDelay = e.drawerTimerDelay || 400),
        (this.redrawDelay = 16),
        (this.triggerMode = e.triggerMode || "click"),
        (this.mobileOpen = !1),
        (this.isMobile = window.innerWidth < this.mobileThreshold),
        (this.wasMobile = window.innerWidth < this.mobileThreshold),
        (this.mobileThreshold = 1120),
        (this.isScrolling = !1),
        (this.isScrollLocked = !1),
        (this.toggleDropdown = function (t, e) {
          var i;
          if (
            ("string" == typeof t
              ? (i = t)
              ...
              : t instanceof Event &&
                (t.preventDefault(),
                t.stopPropagation(),
                (i = t.target.dataset.navDropdown),
                (e = 0 === t.detail)),
            !this.dropdowns[i])
          )
            return (
              Bugsnag.notifyException(
                "DropdownNavigation.toggleDropdown() was called with " +
                  i +
                  ", which is not a valid dropdown id."
              ),
              !1
            );
          (this.wasMobile = this.isMobile),
            (this.isMobile = window.innerWidth < this.mobileThreshold),
            this.activeDropdownId === i
              ? this.closeDropdown(!1)
              : this.openDropdown(i, e);
        }),
        (this.toggleMobileMenu = function () {
          (this.wasMobile = this.isMobile),
            ...
            this.mobileOpen
              ? ((this.mobileOpen = !1),
                (this.previousActiveDropdownId = this.activeDropdownId),
                (this.activeDropdownId = null))
              : (this.mobileOpen = !0),
        ...
        (this.openDropdown = function (t, e) {
          ...
          if (!i)
            return (
              Bugsnag.notifyException(
                "DropdownNavigation.openDropdown() was called with " +
                  t +
                  ", which is not a valid dropdown id."
              ),
              !1
          ...
          (this.previousActiveDropdownId = this.activeDropdownId),
            (this.activeDropdownId = t),
            this.updateActiveClasses(),
            e
              ? i.querySelector(".navigation__dropdown__item a").focus()
        ...
        (this.closeDropdown = function (t) {
          (this.previousActiveDropdownId = this.activeDropdownId),
            (this.activeDropdownId = null),
            this.updateActiveClasses(),
            (!this.previousActiveDropdownId && this.isMobile) ||
              (t
                ? this.dropdowns[this.previousActiveDropdownId].link.focus()
                : document.activeElement instanceof Element &&
                  document.activeElement.blur());
        }),
        (this.updateActiveClasses = function () {
          ...
          t &&
            (t.dropdown.setAttribute("aria-hidden", "true"),
            t.dropdown.classList.remove("-active"),
            t.link.setAttribute("aria-expanded", "false"),
            t.link.classList.remove("-active")),
            e &&
              (e.dropdown.setAttribute("aria-hidden", "false"),
              e.dropdown.classList.add("-active"),
              e.link.setAttribute("aria-expanded", "true"),
              e.link.classList.add("-active"),
              this.activateSections(
                this.activeDropdownId,
                this.previousActiveDropdownId
              )),
            e &&
              !this.isMobile &&
              (this.openDrawer(),
              this.setFeaturedBackgroundPosition(
                this.activeDropdownId,
                this.previousActiveDropdownId
              )),
            !e &&
            ...
            e ||
              ...
              this.isMobile ||
              (this.closeDrawer(),
              this.drawerCloseTimer && clearTimeout(this.drawerCloseTimer),
              (this.drawerCloseTimer = setTimeout(
                function () {
                  this.header.classList.remove("-dropdown-active");
                }.bind(this),
                this.drawerTimerDelay
              ))),
            e &&
              !t &&
              (this.header.classList.add("-dropdown-active"),
              this.footer.setAttribute("aria-hidden", "false")),
            !e || t || this.isMobile || this.scrim.classList.add("-active"),
            this.isMobile
              ? this.setFeaturedBackgroundPosition(null, null)
              : (this.moveLinkIndicator(
                  this.activeDropdownId,
                  this.previousActiveDropdownId
                ),
                this.unlockScroll()),
            this.isMobile &&
              !this.mobileOpen &&
              this.navigationLinkWrapper &&
              (this.navigationLinkWrapper.classList.remove("-active"),
                  ...
                  setTimeout(function () {
                    (t.style.transition = ""),
                      ...
                      (t.style.transitionDelay =
                        50 * e + (s === DIRECTION.DOWN ? 200 : 100) + "ms"),
        ...
        (this.calculateDirection = function (t, e) {
          return t && !e
            ...
            : this.isMobile
            ? DIRECTION.DOWN
            : Object.keys(this.dropdowns).indexOf(t) >
              Object.keys(this.dropdowns).indexOf(e)
            ? DIRECTION.RIGHT
            : DIRECTION.LEFT;
        }),
        (this.deactivateSections = function (t, e) {
          this.dropdowns[t].sections.forEach(function (t) {
            if ((t.classList.remove("-active"), e))
              switch (
                ((t.style.transition =
                  "transform 120ms cubic-bezier(1, 0.01, 1, 0.99), opacity 120ms cubic-bezier(1, 0.01, 1, 0.99)"),
                e)
              ) {
                case DIRECTION.LEFT:
        ...
        (this.openDrawer = function () {
          var t;
          (t = this.isMobile ? "100%" : this.calculateDrawerHeight()),
            this.dropdownWrapper.classList.add("-active"),
            this.setDrawerHeight(t);
        }),
        ...
        (this.resetDropdownMaxHeight = function () {
          var t = document.querySelectorAll(
            ".siteHeader__wrapper .navigation__dropdown"
          );
          t &&
        ...
        (this.setDrawerHeightsForActiveTopbar = function () {
          if (this.topbar && !AsanaHelpers.isMobilePlatform()) {
            var t = this.topbar.getBoundingClientRect().height;
            if (this.navigationDrawerDropdowns.length > 0) {
              var e = 0,
                i = 0;
              this.headerRow &&
                (e = this.headerRow.getBoundingClientRect().height),
                this.footer && (i = this.footer.getBoundingClientRect().height);
              var o = "calc(100vh - " + (e + i + t + "px") + ")";
              this.navigationDrawerDropdowns.forEach(function (t) {
                t.style.maxHeight = o;
              });
            }
          }
        ...
        (this.setDrawerHeight = function (t) {
          (this.dropdownWrapper.style.transition = ""),
        ...
        (this.closeDrawer = function () {
          (this.dropdownWrapper.style.transition =
            "transform 300ms cubic-bezier(1, 0.01, 1, 0.99), opacity 450ms cubic-bezier(1, 0.01, 1, 0.99)"),
            (this.dropdownWrapper.style.transform = "translateY(0)"),
            this.dropdownWrapper.classList.remove("-active");
        }),
        (this.setFeaturedBackgroundPosition = function (t, e) {
          if (!t)
            return (
              (this.featuredBackground.style.transition = "none"),
              void (this.featuredBackground.style.transform = "none")
            );
          ...
          e ||
            ...
            (this.featuredBackground.style.transform =
              "translateX(" + -o + "px)");
        }),
        (this.moveLinkIndicator = function (t, e) {
          if (!t && !e)
            return (
              ...
              void (this.indicator.style.transform = "translateX(0) scaleX(0)")
            );
          ...
          e
            ? (this.indicator.style.transform =
                "translateX(" + o + "px) scaleX( " + s + ")")
            : ((this.indicator.style.transition = "none"),
              (this.indicator.style.transform =
                "translateX(" + o + "px) scaleX(0)"),
              setTimeout(
                function () {
        ...
        (this.recalculateLayout = function () {
          ...
          !this.isMobile &&
            this.activeDropdownId &&
            (this.setDrawerHeight(this.calculateDrawerHeight()),
            this.setFeaturedBackgroundPosition(this.activeDropdownId),
            this.moveLinkIndicator(this.activeDropdownId));
        }),
        (this.focusColumn = function (t) {
          ...
          if (e.classList.contains("navigation__dropdown__item")) {
            ...
            Array.prototype.forEach.call(o, function (e, n) {
              i === e &&
                (t === DIRECTION.RIGHT && (s = n === o.length - 1 ? 0 : n + 1),
                t === DIRECTION.LEFT &&
                  (s = 0 === n ? (s = o.length - 1) : n - 1));
            }),
        ...
        (this.focusItem = function (t) {
          var e =
            document.activeElement.parentElement.parentElement.parentElement;
          if (e.classList.contains("navigation__dropdown__item")) {
            var i = e.parentElement.parentElement.querySelectorAll(
                ".navigation__dropdown__item"
              ),
              o = 0;
            Array.prototype.forEach.call(i, function (s, n) {
              e === s &&
                (t === DIRECTION.DOWN && (o = n === i.length - 1 ? 0 : n + 1),
                t === DIRECTION.UP &&
                  (o = 0 === n ? (o = i.length - 1) : n - 1));
            }),
        ...
        (this.calculateScrollClasses = function () {
          ...
          if (
            (this.topbar &&
              this.topbar.classList.contains("-is-active") &&
              (e = this.topbar.clientHeight),
            t > e)
          ) {
        ...
        (this.initResourceClasses = function () {
          var t = this.header.querySelector(
            ".navigation__dropdown__resource-card"
          );
          if (t) {
        ...
        (this.bindDropdownListeners = function () {
          ...
          for (t = 0; t < this.navigationLinks.length; t++) {
            var i = (e = this.navigationLinks[t]).dataset.navDropdown,
              ...
              d = this;
            "hover" === this.triggerMode &&
              (o.addEventListener(
                "mouseenter",
                this.cancelDropdownClose.bind(this)
              ),
              o.addEventListener(
                "mouseleave",
                this.queueDropdownClose.bind(this)
              ),
          ...
          "click" === this.triggerMode &&
            ...
            window.addEventListener(
              "resize",
              this.recalculateLayout.bind(this)
            ),
        ...
        (this.init = function () {
          this.calculateScrollClasses(),
            this.isShort ||
              ...
              this.setDrawerHeightsForActiveTopbar());
        }))
      : Bugsnag.notifyException(
          'DropdownNavigation was initialized with the selector "' +
            t +
            '", which did not exist in the DOM at the time of initialization'
        );
  };
window.addEventListener("load", function () {
  (window.nav = new DropdownNavigation(".siteHeader")),
    window.nav.init(),
    window.addEventListener("scroll", function () {
      window.nav.calculateScrollClasses();
    });
});
